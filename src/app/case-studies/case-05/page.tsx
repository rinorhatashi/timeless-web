...
const Case05PageContent = () => {
  const { t } = useI18n()

  return (
    <PageLayout
      title={t('pages.caseStudies.case05.title')}
      description={t('pages.caseStudies.case05.description')}
      breadcrumbs={[
        { label: t('navigation.caseStudies'), href: '/case-studies' },
        { label: t('pages.caseStudies.case05.breadcrumb'), href: '/case-studies/case-05' }
      ]}
    >
      <Section>
        <div className="mb-8">
        ...
        <div className="grid-2 gap-8">
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.caseStudies.case05.problem')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.caseStudies.case05.approach')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.caseStudies.case05.stack')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.caseStudies.case05.impact')}
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section variant="dark">
        <div className="text-center">
          <h2 className="text-3xl font-normal mb-6 text-white">
            {t('pages.caseStudies.case05.ctaTitle')}
          </h2>
          <p className="text-xl text-white opacity-90 max-w-2xl mx-auto mb-8">
            {t('pages.caseStudies.case05.ctaSubtitle')}
          </p>
          <Link 
            href="/contact" 
          ...
          >
            {t('pages.caseStudies.case05.ctaButton')}
          </Link>
        </div>
      </Section>
    </PageLayout>
