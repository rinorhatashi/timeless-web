...
const Case06PageContent = () => {
  const { t } = useI18n()

  return (
    <PageLayout
      title={t('pages.caseStudies.case06.title')}
      description={t('pages.caseStudies.case06.description')}
      breadcrumbs={[
        { label: t('navigation.caseStudies'), href: '/case-studies' },
        { label: t('pages.caseStudies.case06.breadcrumb'), href: '/case-studies/case-06' }
      ]}
    >
      <Section>
        <div className="mb-8">
        ...
        <div className="flex items-center gap-4 mb-12">
          <span className="px-4 py-2 bg-blue-50 text-blue-700 rounded-full text-sm font-medium border border-blue-200">
            {t('common.industry.manufacturing')}
          </span>
        ...
        <div className="grid-2 gap-8">
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.caseStudies.case06.problem')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.caseStudies.case06.approach')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.caseStudies.case06.stack')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.caseStudies.case06.impact')}
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section variant="dark">
        <div className="text-center">
          <h2 className="text-3xl font-normal mb-6 text-white">
            {t('pages.caseStudies.case06.ctaTitle')}
          </h2>
          <p className="text-xl text-white opacity-90 max-w-2xl mx-auto mb-8">
            {t('pages.caseStudies.case06.ctaSubtitle')}
          </p>
          <Link 
            href="/contact" 
          ...
          >
            {t('pages.caseStudies.case06.ctaButton')}
          </Link>
        </div>
      </Section>
    </PageLayout>
