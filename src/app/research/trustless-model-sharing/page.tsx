...
const TrustlessModelSharingPageContent = () => {
  const { t } = useI18n()

  return (
    <PageLayout
      title={t('pages.research.trustlessModelSharing.title')}
      description={t('pages.research.trustlessModelSharing.description')}
      breadcrumbs={[
        { label: t('navigation.research'), href: '/research' },
        { label: t('pages.research.trustlessModelSharing.breadcrumb'), href: '/research/trustless-model-sharing' }
      ]}
    >
      <Section>
        <div className="mb-8">
        ...
        <div className="grid-2 gap-8">
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.trustlessModelSharing.objective')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.trustlessModelSharing.method')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.trustlessModelSharing.evaluation')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.trustlessModelSharing.artifact')}
            </p>
          </div>
        </div>
      </Section>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg text-gray-600">
            <p className="leading-relaxed">
              {t('pages.research.trustlessModelSharing.overview')}
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section variant="dark">
        <div className="text-center">
          <h2 className="text-3xl font-normal mb-6 text-white">
            {t('pages.research.trustlessModelSharing.ctaTitle')}
          </h2>
          <p className="text-xl text-white opacity-90 max-w-2xl mx-auto mb-8">
            {t('pages.research.trustlessModelSharing.ctaSubtitle')}
          </p>
          <Link 
            href="/contact" 
          ...
          >
            {t('pages.research.trustlessModelSharing.ctaButton')}
          </Link>
        </div>
      </Section>
    </PageLayout>
...
export default function TrustlessModelSharingPage() {
  return (
    <ContentLoader>
      <TrustlessModelSharingPageContent />
    </ContentLoader>
  )
} 