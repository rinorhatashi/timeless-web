...
const MultimodalRealTimePageContent = () => {
  const { t } = useI18n()

  return (
    <PageLayout
      title={t('pages.research.multimodalRealTime.title')}
      description={t('pages.research.multimodalRealTime.description')}
      breadcrumbs={[
        { label: t('navigation.research'), href: '/research' },
        { label: t('pages.research.multimodalRealTime.breadcrumb'), href: '/research/multimodal-real-time' }
      ]}
    >
      <Section>
        <div className="mb-8">
        ...
        <div className="grid-2 gap-8">
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.multimodalRealTime.objective')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.multimodalRealTime.method')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.multimodalRealTime.evaluation')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.multimodalRealTime.artifact')}
            </p>
          </div>
        </div>
      </Section>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg text-gray-600">
            <p className="leading-relaxed">
              {t('pages.research.multimodalRealTime.overview')}
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section variant="dark">
        <div className="text-center">
          <h2 className="text-3xl font-normal mb-6 text-white">
            {t('pages.research.multimodalRealTime.ctaTitle')}
          </h2>
          <p className="text-xl text-white opacity-90 max-w-2xl mx-auto mb-8">
            {t('pages.research.multimodalRealTime.ctaSubtitle')}
          </p>
          <Link 
            href="/contact" 
          ...
          >
            {t('pages.research.multimodalRealTime.ctaButton')}
          </Link>
        </div>
      </Section>
    </PageLayout>
...
export default function MultimodalRealTimePage() {
  return (
    <ContentLoader>
      <MultimodalRealTimePageContent />
    </ContentLoader>
  )
} 