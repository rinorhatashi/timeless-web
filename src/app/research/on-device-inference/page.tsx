...
const OnDeviceInferencePageContent = () => {
  const { t } = useI18n()

  return (
    <PageLayout
      title={t('pages.research.onDeviceInference.title')}
      description={t('pages.research.onDeviceInference.description')}
      breadcrumbs={[
        { label: t('navigation.research'), href: '/research' },
        { label: t('pages.research.onDeviceInference.breadcrumb'), href: '/research/on-device-inference' }
      ]}
    >
      <Section>
        <div className="mb-8">
        ...
        <div className="grid-2 gap-8">
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.onDeviceInference.objective')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.onDeviceInference.method')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.onDeviceInference.evaluation')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.onDeviceInference.artifact')}
            </p>
          </div>
        </div>
      </Section>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg text-gray-600">
            <p className="leading-relaxed">
              {t('pages.research.onDeviceInference.overview')}
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section variant="dark">
        <div className="text-center">
          <h2 className="text-3xl font-normal mb-6 text-white">
            {t('pages.research.onDeviceInference.ctaTitle')}
          </h2>
          <p className="text-xl text-white opacity-90 max-w-2xl mx-auto mb-8">
            {t('pages.research.onDeviceInference.ctaSubtitle')}
          </p>
          <Link 
            href="/contact" 
          ...
          >
            {t('pages.research.onDeviceInference.ctaButton')}
          </Link>
        </div>
      </Section>
    </PageLayout>
...
export default function OnDeviceInferencePage() {
  return (
    <ContentLoader>
      <OnDeviceInferencePageContent />
    </ContentLoader>
  )
} 