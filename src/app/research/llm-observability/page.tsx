...
const LLMObservabilityPageContent = () => {
  const { t } = useI18n()

  return (
    <PageLayout
      title={t('pages.research.llmObservability.title')}
      description={t('pages.research.llmObservability.description')}
      breadcrumbs={[
        { label: t('navigation.research'), href: '/research' },
        { label: t('pages.research.llmObservability.breadcrumb'), href: '/research/llm-observability' }
      ]}
    >
      <Section>
        <div className="mb-8">
        ...
        <div className="grid-2 gap-8">
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.llmObservability.objective')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.llmObservability.method')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.llmObservability.evaluation')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.llmObservability.artifact')}
            </p>
          </div>
        </div>
      </Section>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg text-gray-600">
            <p className="leading-relaxed">
              {t('pages.research.llmObservability.overview')}
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section variant="dark">
        <div className="text-center">
          <h2 className="text-3xl font-normal mb-6 text-white">
            {t('pages.research.llmObservability.ctaTitle')}
          </h2>
          <p className="text-xl text-white opacity-90 max-w-2xl mx-auto mb-8">
            {t('pages.research.llmObservability.ctaSubtitle')}
          </p>
          <Link 
            href="/contact" 
          ...
          >
            {t('pages.research.llmObservability.ctaButton')}
          </Link>
        </div>
      </Section>
    </PageLayout>
