...
const SovereignAIPageContent = () => {
  const { t } = useI18n()

  return (
    <PageLayout
      title={t('pages.research.sovereignAI.title')}
      description={t('pages.research.sovereignAI.description')}
      breadcrumbs={[
        { label: t('navigation.research'), href: '/research' },
        { label: t('pages.research.sovereignAI.breadcrumb'), href: '/research/sovereign-ai' }
      ]}
    >
      <Section>
        <div className="mb-8">
        ...
        <div className="grid-2 gap-8">
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.sovereignAI.objective')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.sovereignAI.method')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.sovereignAI.evaluation')}
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="text-gray-600 leading-relaxed">
              {t('pages.research.sovereignAI.artifact')}
            </p>
          </div>
        </div>
      </Section>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg text-gray-600">
            <p className="leading-relaxed">
              {t('pages.research.sovereignAI.overview')}
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section variant="dark">
        <div className="text-center">
          <h2 className="text-3xl font-normal mb-6 text-white">
            {t('pages.research.sovereignAI.ctaTitle')}
          </h2>
          <p className="text-xl text-white opacity-90 max-w-2xl mx-auto mb-8">
            {t('pages.research.sovereignAI.ctaSubtitle')}
          </p>
          <Link 
            href="/contact" 
          ...
          >
            {t('pages.research.sovereignAI.ctaButton')}
          </Link>
        </div>
      </Section>
    </PageLayout>
